...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        <img class="img-fluid rounded z-depth-1" src="{{ '/assets/img/synchron-01.jpg' | relative_url }}" alt="" title="example image"/>
    </div>
</div>
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        <img class="img-fluid rounded z-depth-1" src="{{ '/assets/img/synchron-02.jpg' | relative_url }}" alt="" title="example image"/>
    </div>
</div>
