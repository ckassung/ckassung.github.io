...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        <img class="img-fluid rounded z-depth-1" src="{{ '/assets/img/filtering-oranienburg-01.jpg' | relative_url }}" alt="" title="example image"/>
    </div>
</div>
...
ist es niemals (vgl. Cubasch, Alwin J. et al. (2021) und Kassung (2023)).
...
Um die Wende zum 20. Jahrhundert siedelten sich in Oranienburg große
Chemiefabriken der Gaslichtindustrie an. Aus den dort raffinierten
